...
public:
    ...
    void setupUi(QMainWindow *MainWin)
    {
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/ico/ico/icons/420.bmp"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        ...
        gridLayout_9->addLayout(horizontalLayout_2, 3, 0, 1, 5);
        ...
        sizePolicy.setHeightForWidth(radioButton_11->sizePolicy().hasHeightForWidth());
        radioButton_11->setSizePolicy(sizePolicy);

        gridLayout_9->addWidget(radioButton_11, 1, 5, 1, 1);
        ...
        horizontalSpacer_6 = new QSpacerItem(62, 15, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        horizontalSpacer_5 = new QSpacerItem(43, 15, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        horizontalSpacer_3 = new QSpacerItem(62, 15, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        gridLayout_9->addWidget(line, 7, 0, 1, 6);
    ...
    void retranslateUi(QMainWindow *MainWin)
    {
        ...
        action_14->setText(QApplication::translate("MainWin", "\347\263\273\347\273\237\350\256\276\347\275\256", nullptr));
