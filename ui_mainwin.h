...
"}"));
        ...
        gridLayout_9->addLayout(gridLayout_3, 5, 0, 1, 2);
        ...
        gridLayout_9->addLayout(gridLayout_7, 5, 3, 1, 1);

        horizontalSpacer_2 = new QSpacerItem(90, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_9->addItem(horizontalSpacer_2, 5, 4, 1, 1);
        ...
        gridLayout_9->addLayout(gridLayout_8, 5, 5, 1, 1);
        ...
        gridLayout_9->addWidget(line, 6, 0, 1, 6);
        ...
        gridLayout_9->addLayout(horizontalLayout, 1, 0, 1, 6);
        ...
        gridLayout_9->addLayout(horizontalLayout_2, 3, 0, 1, 6);
